(() => {
  ...
  const data = {
    ...
    series: ['InfluxDB','Building · NAS · InfluxDB 2','Time-series storage for timestamped measurements, trends and diagnostics. Node-RED ingestion and Grafana queries are proposed integrations; persistent storage is part of the setup.'],
    sql: ['MariaDB','Active · NAS · MariaDB 11.8','Relational storage for application records and reference data, managed through DBeaver on the trusted LAN. The connection from Node-RED is proposed and does not imply every sensor message belongs in this database.'],
    ...
    portainer: ['Portainer','Connected · NAS · Management plane','Portainer runs on NAS and manages all Docker containers on both NAS and AI Server. Local management covers the NAS services, including Mosquitto, Node-RED, InfluxDB and MariaDB. Remote management connects to the AI Server Portainer Agent on port 9001. These management links are separate from the IoT measurement pipeline.'],
    engine: ['AI Server','Ubuntu Server 24.04.4 LTS · RTX 3090 24 GB · 32 GB RAM','The GPU compute host runs Docker with NVIDIA Container Toolkit and Ollama. Portainer on NAS manages its containers, and Grafana monitors GPU performance. NVIDIA driver 595.71.05 and Docker Engine 29.5.3 are documented in the setup notes.'],
