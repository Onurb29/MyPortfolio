(() => {
  ...
  const data = {
    ...
    logic: ['Node-RED','Active · NAS','Processes messages and routes data. The proposed design sends timestamped measurements to InfluxDB and uses MariaDB for structured context and records. These arrows are design intent, not confirmed running flows.'],
